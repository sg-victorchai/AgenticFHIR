...
export const AgentConversationModal: React.FC<AgentConversationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-40 flex items-end sm:items-start justify-center">
      <div
        ref={modalRef}
        className="bg-white rounded-t-xl sm:rounded-xl shadow-xl w-full sm:absolute sm:w-[46.2rem] sm:min-w-[36rem] sm:max-w-[95vw] sm:resize-x sm:overflow-auto max-h-[90vh] sm:max-h-[85vh] flex flex-col"
      >
        <div
